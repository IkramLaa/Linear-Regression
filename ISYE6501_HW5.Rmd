...
I work in energy sector and we have to predict the prices of electricity since most of the utilities in California don't own power generation and they buy electricity from CAISO that manages 4,599 actives node energy market. ISO manages California wholesale electricity.
As consumer, the price of electricity is fixed, but utilities have some variations of the price and they have to purchase electricity a day ahead to provide balance in the grid. Linear regression helps explain variables that impact the electricity prices. the  5 predictors are: weather, power plants generation, fuel costs, renewable generation, loads.
